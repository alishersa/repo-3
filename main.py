...
import os
class ConfigMessage:
    def __init__(self, log_level, grpc_port, environment, db_url, pod_ip):
...
def get_config():
    ...
    pod_ip = get_env_variable('POD_IP', '10.01.10.01')
        
    message = ConfigMessage(log_level, grpc_port, environment, db_url, pod_ip)
